			...
			<section id="sports">
				<div class="conatiner-fluid">
					...
					<div class="height"></div>
						<div class="row">
							<div class="col-md-8 col-xs-12">
								<div class=" margin" style="border-bottom:2px solid #66bb6a;">
									<h5>SPORTS NEWS</h5>
								</div>
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="embed-responsive embed-responsive-16by9">
									<iframe width="560" height="315" src="https://www.youtube.com/embed/d_OeQxoKocU?list=PLS3XGZxi7cBXqnRTtKMU7Anm-R-kyhkyC" frameborder="0" allowfullscreen></iframe>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="row">
								<section id="categories">
									...
									<div class="row">
										<ul>
											@foreach($cat->take(11) as $cats)
											@foreach($cats->xeber()->take(1)->orderBy('id','desc')->get() as $news)
												<li><a href="{{url('/category/'.$cats->id)}}">{{ $news->category->category_name }}</a></li>
											@endforeach
											@endforeach
